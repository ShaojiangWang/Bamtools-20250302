...
bool BamMultiReader::Open(const std::vector<std::string>& filenames) {
    ...
    //return d->CreateReaderThreads(filenames);   // swang big change inside
}

// swang begin
/***/
bool BamMultiReader::CreateThreads(const std::vector<std::string>& filenames) {
    return d->CreateReaderThreads(filenames);
}
/***/
// swang end
